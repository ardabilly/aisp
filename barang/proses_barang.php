...
// ===========================================================================================
    ...
    echo "<script>alert('Barang masuk berhasil ditambahkan'); window.location.href='../barang.php?page=inputbarangmasuk';</script>";
...
// ===========================================================================================
    ...
    if ($jumlah_pinjam > $jumlah_brg) {
        ...
        echo "<script>alert('Jumlah barang yang dipinjam terlalu banyak! Jumlah barang tersedia hanya = $jumlah_brg, mohon kembali input ulang.'); window.location.href='../barang.php?page=formpeminjaman';</script>";
    ...
    echo "<script>alert('Data peminjaman tersimpan'); window.location.href='../barang.php?page=peminjaman';</script>";
...
// ===========================================================================================
    ...
    if ($keterangan == "Sudah dikembalikan") {
        ...
        echo "<script>alert('Data barang dikembalikan ke stok'); window.location.href='../barang.php?page=peminjaman';</script>";
...
else if($aksi == "updatebarang")
{
    ...
    if ($query) {
        if ($cek > 0) {
            ...
            if ($queryupdate) {
                echo "<script>alert('Data berhasil diubah'); window.location.href='../barang.php';</script>";
            }
        }
                echo "<script>alert('Data berhasil diubah'); window.location.href='../barang.php';</script>";
